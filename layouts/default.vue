...
import { FolderIcon, HomeIcon, XMarkIcon } from "@heroicons/vue/24/outline";

const navigation = [
  { name: "Dashboard", href: "/", icon: HomeIcon },
  { name: "Ore Refining", href: "/ore-refining", icon: FolderIcon },
];
        ...
        <div class="fixed inset-0 flex">
          ...
          >
            <DialogPanel class="relative mr-16 flex w-full max-w-xs flex-1">
              ...
              <div
                class="flex grow flex-col gap-y-5 overflow-y-auto px-6 pb-2 ring-1 ring-white/10"
              >
